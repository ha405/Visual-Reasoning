...
def main():
    ...
    for test_domain in DOMAINS:
        ...
        # DEBUG: Use all-ones mask (no pruning at all)
        print("\n>>> DEBUG: Using NO PRUNING (all weights kept)")
        aggregated_masks = [torch.ones(10, 10).to(DEVICE) for _ in range(4)]
        summed_saliencies = aggregated_masks  # dummy
        normalized_saliencies = aggregated_masks  # dummy
