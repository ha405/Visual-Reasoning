...
IMPORTANCE_THRESHOLD_PERCENTILE = 80  # Top 60% marked as important (1), rest as 0

# ============================================================================
# PHASE 2: CROSS-DOMAIN GENERALIZATION CONFIGURATION (WITH PRUNING)
# ============================================================================
PH2_NUM_EPOCHS = 10
PH2_BATCH_SIZE = 32
PH2_LEARNING_RATE = 1e-3  # Learning rate for non-pruned (important) weights
