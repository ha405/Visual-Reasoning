...
class FeedforwardClassifier(nn.Module):
    ...
    def get_hidden_layer_weights(self):
        ...
        weights = []
        for layer in self.hidden_layers:
            weights.append(layer.weight.data.clone())  # [out_features, in_features] = [10, 10]
        return weights
    ...
    def set_hidden_layer_weights(self, weights):
        ...
        """
        assert len(weights) == NUM_HIDDEN_LAYERS, f"Expected {NUM_HIDDEN_LAYERS} weight matrices"
