...
class PACSDataset:
    ...
    def get_single_domain_loader(
        self, domain, batch_size=32, shuffle=True, train_split=None
    ):
        """
    ...
    def get_multi_domain_loader(
        self, domains, batch_size=32, shuffle=True, train_split=0.8
    ):
        """
        ...
        train_loader = DataLoader(
            combined_train, batch_size=batch_size, shuffle=shuffle
        )
    ...
    def get_lodo_loaders(self, test_domain, batch_size=32):
        ...
        train_loader, val_loader = self.get_multi_domain_loader(
            train_domains, batch_size=batch_size, shuffle=True
        )
